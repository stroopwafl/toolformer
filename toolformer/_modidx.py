...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'toolformer.core': { 'toolformer.core.get_device': ('core.html#get_device', 'toolformer/core.py'),
            ...
            'toolformer.inference': { 'toolformer.inference.load_finetuned_model': ( 'inference.html#load_finetuned_model',
                                                                                     'toolformer/inference.py'),
                                      'toolformer.inference.sample_with_tools': ( 'inference.html#sample_with_tools',
                                                                                  'toolformer/inference.py')},
